export default function Svg({ width = 12, stroke = "black" }: { width?: number; stroke?: string } = {}) {
  return (
    <svg width={width} height={width} viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g clip-path="url(#clip0_1545_11328)">
        <path
        ...
        />
        <path d="M13.5 13.5L9.75 9.75" stroke={stroke} stroke-linecap="round" stroke-linejoin="round" />
      </g>
      <defs>
